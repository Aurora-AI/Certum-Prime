...
Parameters
target
: [Object | Selector text | Array]
The target object of the tweens.
nested
: Boolean
(default =
true
) - Determines whether or not tweens that are inside nested timelines should be returned. If you only want the "top level" tweens and timelines, set this to
false
.
Returns : Array
â
