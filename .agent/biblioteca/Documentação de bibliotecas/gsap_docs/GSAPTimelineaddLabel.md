...
Details
â
Adds a label to the timeline, making it easy to mark important positions/times. You can then reference that label in other methods, like
seek("myLabel")
or
add(myTween, "myLabel")
or
...
4
Play
Positioning labels in a timeline
â
By default, labels are added to the
end
