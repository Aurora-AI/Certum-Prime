...
Details
â
Gets/Sets the scroll position of the associated scroller (numeric). Remember that a ScrollTrigger is EITHER linked to
vertical
OR
horizontal
scrolling, so scroll() only affects that direction.
Example
â
let
st
