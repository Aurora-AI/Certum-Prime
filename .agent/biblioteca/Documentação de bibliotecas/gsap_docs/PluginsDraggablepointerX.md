...
- The
x
(horizontal) position of the pointer (mouse or touch) associated with the Draggable's last event (like
event.pageX
). In most cases, this should be used instead of using the event's
.pageX
