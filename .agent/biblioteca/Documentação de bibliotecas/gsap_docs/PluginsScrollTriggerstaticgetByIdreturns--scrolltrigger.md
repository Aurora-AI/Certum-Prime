...
id
: String
The identifier string that was used as the ScrollTrigger's
id
Returns : ScrollTrigger
â
The ScrollTrigger instance with the matching
id
(or undefined if no matching ScrollTriggers are found)
Details
â
Returns the ScrollTrigger that was assigned the corresponding
id
