# https://tailwindcss.com/plus/templates/oatmeal
...
Elegant marketing website kit built with Tailwind CSS and Tailwind Plus Elements.

React

Next.js

[Live preview](https://tailwindcss.com/plus/kits/oatmeal/preview?theme=olive_instrument)[Get template](#pricing)

Olive

Instrument

![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-1-olive_instrument-light-b9f91b0a-1011x724@3.png)![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-1-olive_instrument-dark-2b6e0b04-1011x724@3.png)

![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-2-olive_instrument-light-48cc685d-501x358@3.png)![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-2-olive_instrument-dark-07a3b293-501x358@3.png)

![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-3-olive_instrument-light-b8eb1172-501x358@3.png)![Oatmeal](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/banner-3-olive_instrument-dark-f1fb7ec2-501x358@3.png)
...
Oatmeal is a beautiful SaaS marketing kit built with Tailwind CSS and Tailwind Plus Elements, designed and built by the Tailwind CSS team.
...
Take a look at the example pages to explore the component APIs, and see just how versatile the Oatmeal kit can be. There's never been a faster way to build a thoughtfully designed marketing website with Tailwind CSS.
...
**Choose your theme** — choose from four hand-picked color palettes and three different font combinations that look great out of the box, or easily customize with your own.

**Plug and play** — with over 30 pre-built sections, you can mix and match to create a combination that suits your needs perfectly - no designer required.

**100+ icons** — an all-new duotone icon set designed specifically for this kit, making it easy to enhance your design without hunting for icons that fit the aesthetic yourself.
...
![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-1-olive_instrument-light-d0df8128-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-2-olive_instrument-light-1c89e7dc-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-3-olive_instrument-light-094a98c6-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-4-olive_instrument-light-029cb66d-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-1-olive_instrument-dark-5d29c966-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-2-olive_instrument-dark-7061a8d1-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-3-olive_instrument-dark-18f76c09-384x246@3.png)![](https://cdn.tailwindplus.com/kits/oatmeal/marketing/example-1/screenshot-4-olive_instrument-dark-ce3a9b41-384x246@3.png)
...
[Get template](https://tailwindcss.com/plus/checkout/69024fdd-55bf-4ca7-9f1f-7c1f4e7b7595)

A calm marketing site kit with multiple themes, flexible enough for any project.
