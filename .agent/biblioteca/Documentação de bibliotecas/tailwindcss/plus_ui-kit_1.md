...
[Documentation](https://catalyst.tailwindui.com/docs)[Get UI kit](#pricing)

![](/plus-assets/img/heroes/ui-kit-col-1.png)![](/plus-assets/img/heroes/ui-kit-col-1-dark.png)![](/plus-assets/img/heroes/ui-kit-col-2.png)![](/plus-assets/img/heroes/ui-kit-col-2-dark.png)![](/plus-assets/img/heroes/ui-kit-col-3.png)![](/plus-assets/img/heroes/ui-kit-col-3-dark.png)
...
* [![](/plus-assets/img/templates/catalyst/components/dropdown.png)![](/plus-assets/img/templates/catalyst/components/dropdown-dark.png)

  Dropdown](https://catalyst.tailwindui.com/docs/dropdown)
* [![](/plus-assets/img/templates/catalyst/components/alert.png)![](/plus-assets/img/templates/catalyst/components/alert-dark.png)

  Alert](https://catalyst.tailwindui.com/docs/alert)
* [![](/plus-assets/img/templates/catalyst/components/navbar.png)![](/plus-assets/img/templates/catalyst/components/navbar-dark.png)

  Navbar](https://catalyst.tailwindui.com/docs/navbar)
* [![](/plus-assets/img/templates/catalyst/components/avatar.png)![](/plus-assets/img/templates/catalyst/components/avatar-dark.png)

  Avatar](https://catalyst.tailwindui.com/docs/avatar)
* [![](/plus-assets/img/templates/catalyst/components/divider.png)![](/plus-assets/img/templates/catalyst/components/divider-dark.png)

  Divider](https://catalyst.tailwindui.com/docs/divider)
* [![](/plus-assets/img/templates/catalyst/components/textarea.png)![](/plus-assets/img/templates/catalyst/components/textarea-dark.png)

  Textarea](https://catalyst.tailwindui.com/docs/textarea)
* [![](/plus-assets/img/templates/catalyst/components/heading.png)![](/plus-assets/img/templates/catalyst/components/heading-dark.png)

  Heading](https://catalyst.tailwindui.com/docs/heading)
* [![](/plus-assets/img/templates/catalyst/components/text.png)![](/plus-assets/img/templates/catalyst/components/text-dark.png)

  Text](https://catalyst.tailwindui.com/docs/text)
* [![](/plus-assets/img/templates/catalyst/components/fieldset.png)![](/plus-assets/img/templates/catalyst/components/fieldset-dark.png)

  Fieldset](https://catalyst.tailwindui.com/docs/fieldset)
* [![](/plus-assets/img/templates/catalyst/components/dialog.png)![](/plus-assets/img/templates/catalyst/components/dialog-dark.png)

  Dialog](https://catalyst.tailwindui.com/docs/dialog)
* [![](/plus-assets/img/templates/catalyst/components/sidebar-layout.png)![](/plus-assets/img/templates/catalyst/components/sidebar-layout-dark.png)

  Sidebar layout](https://catalyst.tailwindui.com/docs/sidebar-layout)
* [![](/plus-assets/img/templates/catalyst/components/stacked-layout.png)![](/plus-assets/img/templates/catalyst/components/stacked-layout-dark.png)

  Stacked layout](https://catalyst.tailwindui.com/docs/stacked-layout)
* [![](/plus-assets/img/templates/catalyst/components/auth-layout.png)![](/plus-assets/img/templates/catalyst/components/auth-layout-dark.png)
