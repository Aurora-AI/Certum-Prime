# https://sdk.vercel.ai/tools-registry
...
code-executionsandbox](/tools-registry/code-execution)[Exa
...
searchwebextraction](/tools-registry/exa)[Parallel
...
searchwebextraction](/tools-registry/parallel)[ctx-zip
...
code-executionsandboxmcpcode-mode](/tools-registry/ctx-zip)[Perplexity Search
...
searchweb](/tools-registry/perplexity-search)[Tavily
...
searchextractcrawl](/tools-registry/tavily)[Firecrawl
...
scrapingsearchcrawlingextractionweb](/tools-registry/firecrawl)[Amazon Bedrock AgentCore
...
code-executionbrowser-automationsandbox](/tools-registry/bedrock-agentcore)[Superagent
...
securityguardrailspiiprompt-injectionverification](/tools-registry/superagent)[Tako Search

Search Tako's knowledge base for data visualizations, insights, and well-sourced information with charts and analytics.

searchdatavisualizationanalytics](/tools-registry/tako-search)[Valyu
...
searchwebdomain-search](/tools-registry/valyu)[Airweave
...
searchragdata-sourcessemantic-search](/tools-registry/airweave)[bash-tool

Provides bash, readFile, and writeFile tools for AI agents. Supports @vercel/sandbox for full VM isolation.

bashfile-systemsandboxcode-execution](/tools-registry/bash-tool)
