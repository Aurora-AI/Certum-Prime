...
```
<canvas class="glslCanvas" data-fragment-url=âyourShader.frag" data-textures=âyourInputImage.pngâ width="500" height="500"></canvas>
```
...
```
glslViewer yourShader.frag yourInputImage.png âw 500 -h 500 -E screenshot,yourOutputImage.png
```
...
**Curate**: Sharing your code is the beginning of you sharing your shader as artwork! Beside the option to export to [openFrame.io](http://openframe.io/) I made a tool to curate your shaders into a gallery that can be embedded on any site, itâs name is [glslGallery](https://github.com/patriciogonzalezvivo/glslGallery). Learn more [here](https://github.com/patriciogonzalezvivo/glslGallery).
