...
Thanks [Kenichi Yoneda (Kynd)](https://twitter.com/kyndinfo) and [Sawako](https://twitter.com/sawakohome) for the [Japanese translation (æ¥æ¬èªè¨³)](?lan=jp)

Thanks [Tong Li](https://www.facebook.com/tong.lee.9484) and [Yi Zhang](https://www.facebook.com/archer.zetta?pnref=story) for the [Chinese translation (ä¸­æç)](?lan=ch)

Thanks [Jae Hyun Yoo](https://www.facebook.com/fkkcloud) and [June Kim](https://github.com/rlawns324) for the Korean [translation (íêµ­ì´)](?lan=kr)

Thanks Nahuel Coppero (Necsoft) for the Spanish [translation (espaÃ±ol)](?lan=es)

Thanks [Raphaela ProtÃ¡sio](https://github.com/Rawphs) and [Lucas MendonÃ§a](https://github.com/luuchowl) for the Portuguese [translation (portugues)](?lan=pt)

Thanks [Nicolas Barradeau](https://twitter.com/nicoptere) and [Karim Naaji](http://karim.naaji.fr/) for the French [translation (franÃ§ais)](?lan=fr)
...
Thanks [Vu Phuong Hoang](https://www.facebook.com/vuphuonghoang88) for the Vietnamese [translation (Tiáº¿ng Viá»t)](?lan=vi)

Thanks [Wojciech Pachowiak](https://github.com/WojtekPachowiak) for the Polish [translation (polski)](?lan=pl)

Thanks [Manoylov Andriy](https://twitter.com/ManoylovAC) for the Ukrainian [translation (ÑÐºÑÐ°ÑÐ½ÑÑÐºÐ¸Ð¹ Ð¿ÐµÑÐµÐºÐ»Ð°Ð´)](?lan=ua)
...
Sign up for the news letter or follow it on [Twitter](https://twitter.com/bookofshaders) / [Mastodon](https://mastodon.gamedev.place/@bookofshaders) / [Discord](shader.zone)
